...
\tagStructPara{}\paraid{para1}\NeoParStart{A}utomated typesetting systems have historically treated
...
severity of the preamble.\tagStructParaEnd{}%

\tagStructPara{}\paraid{para2}The line-breaking problem, by contrast, is intrinsically local. Given a
...
recompilation should be the paragraph rather than the document.\tagStructParaEnd{}%

\tagStructPara{}\paraid{para3}Word processors have exploited exactly this separation for decades: the
...
engine without sacrificing its output quality.\tagStructParaEnd{}%

\tagStructPara{}\paraid{para4}This paper contributes such a bridge. We capture, for every paragraph of a
...
reproduces the reference document exactly.\tagStructParaEnd{}%

\section{The Locality Property}

\tagStructPara{}\paraid{para5}Consider a paragraph consisting of $n$ items with natural widths $w_i$,
...
approximately $100\,|r|^3$, capped at ten thousand.\tagStructParaEnd{}%

\tagStructPara{}\paraid{para6}The total demerits of a breakpoint sequence combine badness with penalty
terms,
\begin{equation}
...
demerits charged when consecutive lines differ excessively in tightness.\tagStructParaEnd{}%

\tagStructPara{}\paraid{para7}Equation~\eqref{eq:demerits} is minimized by dynamic programming over
...
paragraph in the document.\tagStructParaEnd{}%

\tagStructPara{}\paraid{para8}The dependency set of the line breaker is finite and enumerable: the
...
recompilation, the reproduction is exact.\tagStructParaEnd{}%

\section{System Architecture}

\tagStructPara{}\paraid{para9}Our prototype comprises four cooperating components.\tagStructParaEnd{}%

\tagStructPara{}\paraid{para10}First, a capture pass instruments a normal compilation. Callbacks around
...
commodity Linux workstation.}.\tagStructParaEnd{}%

\tagStructPara{}\paraid{para11}Second, a persistent engine loads the journal class preamble once and then
...
node structures, bypassing page generation entirely.\tagStructParaEnd{}%

\tagStructPara{}\paraid{para12}Third, cross-reference state is transplanted from the reference
...
placeholder marks.\tagStructParaEnd{}%

\tagStructPara{}\paraid{para13}Fourth, a background convergence pass recompiles the full document a short
...
layout is.\tagStructParaEnd{}%

\section{Evaluation}

\tagStructPara{}\paraid{para14}We evaluate fidelity and latency on the journal class of this very
...
font expansion active.\tagStructParaEnd{}%

\tagStructPara{}\paraid{para15}Across the body paragraphs of the test manuscript, isolated recompilation
...
the node list and are routed to the convergence path.\tagStructParaEnd{}%

\tagStructPara{}\paraid{para16}Latency is summarized in Table~\ref{tab:latency}. The keystroke path
...
instantaneous, and comfortably inside a sixty-hertz display frame.\tagStructParaEnd{}%
...
\tagStructPara{}\paraid{para17}The comparison with whole-document recompilation is stark. Even this
...
the document grows.\tagStructParaEnd{}%

\tagStructPara{}\paraid{para18}Memory behavior is equally important for a long-lived engine. Every
...
latency or engine memory.\tagStructParaEnd{}%

\section{Limitations and Future Work}

\tagStructPara{}\paraid{para19}Three limitations bound the present prototype. Paragraphs inside list
...
would maintain an incremental parse of the manuscript instead.\tagStructParaEnd{}%

\tagStructPara{}\paraid{para20}The natural next step is source mapping: deriving paragraph identity from
...
machinery described here is unchanged by that step.\tagStructParaEnd{}%

\section{Conclusion}

\tagStructPara{}\paraid{para21}Pixel-identical \LaTeX{} output and millisecond editing feedback are not
...
typesetting without compromising its typography.\tagStructParaEnd{}%
