...
\begin{center}
\resizebox{0.98\textwidth}{!}{\input{figs/pgc-architecture.tikz}}
\end{center}
...
\item \textbf{Known limits are explicit} --- footnotes, display math,
  ...
  normal 3--5\,s build; preview glyph \emph{positions} are exact, the
  rendered faces are approximate until the next build.
\end{itemize}
